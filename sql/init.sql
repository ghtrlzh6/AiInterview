...
('JAVA_BACKEND', 'Spring Cloud 微服务架构', '服务注册、配置中心、熔断限流', 'ARTICLE', 'https://example.com/spring-cloud', 'Spring Cloud', 3),
('JAVA_BACKEND', 'MySQL索引优化实战', '索引原理、慢查询优化', 'ARTICLE', 'https://example.com/mysql-index', 'MySQL', 2),
('JAVA_BACKEND', 'Redis 深度历险', 'Redis 原理与应用', 'ARTICLE', 'https://example.com/redis-deep', 'Redis', 3),
('WEB_FRONTEND', 'Vue 3 组合式 API 最佳实践', 'Composition API 深入', 'ARTICLE', 'https://example.com/vue3-composition', 'Vue3', 2),
('WEB_FRONTEND', 'React Hooks 完全指南', 'useState, useEffect, useCallback 等', 'ARTICLE', 'https://example.com/react-hooks', 'React', 2),
('WEB_FRONTEND', '前端工程化与构建优化', 'Webpack/Vite、性能优化', 'ARTICLE', 'https://example.com/frontend-build', '工程化', 3),
('WEB_FRONTEND', '深入理解浏览器原理', '渲染流程、事件循环、安全策略', 'ARTICLE', 'https://example.com/browser', '浏览器原理', 3),
('WEB_FRONTEND', 'CSS 布局技巧大全', 'Flex、Grid、居中方案', 'ARTICLE', 'https://example.com/css-layout', 'CSS', 1),
('PYTHON_ALGO', 'LeetCode 刷题指南', '数据结构与算法经典题目', 'ARTICLE', 'https://example.com/leetcode', '算法', 2),
('PYTHON_ALGO', '机器学习入门实战', 'Scikit-learn、模型训练、评估', 'ARTICLE', 'https://example.com/ml-intro', '机器学习', 2),
('PYTHON_ALGO', 'Python 高级特性详解', '装饰器、迭代器、生成器、元编程', 'ARTICLE', 'https://example.com/python-advanced', 'Python', 2),
('PYTHON_ALGO', '推荐系统入门', '协同过滤、内容推荐、召回排序', 'ARTICLE', 'https://example.com/recommender', '推荐系统', 3),
('GAME_CLIENT', 'Unity 游戏开发实战', 'Unity引擎、场景搭建、脚本开发', 'ARTICLE', 'https://example.com/unity-dev', 'Unity', 2),
